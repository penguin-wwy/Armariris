    ...
    private:
        void addDecodeFunction(Module *mod, std::vector<encVar *> *gvars) {
            ...
            for (unsigned i = 0, e = gvars->size(); i != e; ++i) {
                ...
                BinaryOperator *int8_dec = BinaryOperator::Create(Instruction::Xor, int8_20, const_key, "xor",
                                                                  label_for_body);
                // Store
                ...
                // Adjust loop counter
                BinaryOperator *int32_inc = BinaryOperator::Create(Instruction::Add, int32_i, const_1, "inc",
                                                                   label_for_body);
...
static RegisterPass<StringObfuscationPass> X("GVDiv", "Global variable (i.e., const char*) diversification pass", false,
                                             true);
